/**
 * @file serf_save_load.cc
 * @author Chaoji Zuo (chaoji.zuo@rutgers.edu)
 * @brief SeRF Benchmark with Save/Load Index Support
 * @date 2025-01-04
 *
...
int main(int argc, char **argv) {
  ...
  string recursion_type_str = "MAX_POS";
  string version = "SeRF_SaveLoad";
